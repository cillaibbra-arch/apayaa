...
create table if not exists public.feelings_logs (
...
alter table public.feelings_logs enable row level security;

create policy "Anyone can view feelings logs"
on public.feelings_logs
for select
to anon, authenticated
using (true);

create policy "Anyone can insert feelings logs"
on public.feelings_logs
for insert
to anon, authenticated
with check (true);

create policy "Anyone can delete feelings logs"
on public.feelings_logs
for delete
to anon, authenticated
using (true);
